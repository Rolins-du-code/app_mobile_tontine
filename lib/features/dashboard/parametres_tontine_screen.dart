...
class _ParametresTontineScreenState
    extends State<ParametresTontineScreen> {
  ...
  void initState() {
    ...
    _jourLimite =
        widget.tontineData['jourLimite'] as String? ??
            'mercredi';
    _delaiGraceHeures =
        widget.tontineData['delaiGraceHeures'] as int? ?? 0;

    // Parse l'heure stockée "HH:mm"
    final hStr =
        widget.tontineData['heureLimite'] as String? ??
            '20:00';
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    _ligne('Jour limite', _jourLimite[0]
                        .toUpperCase() + _jourLimite.substring(1)),
                    _ligne('Heure limite',
